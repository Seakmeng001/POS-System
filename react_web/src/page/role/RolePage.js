...
const  RolePage= () => {
    ...
    const getList = async () => {
        try {
            ...
            if (res && !res.error) {
                ...
                console.error("Error fetching role:", res.message);
            }
        } catch (error) {
    ...
    const onSubmit = async () => {
        if(payId == ""){
            ...
            const res = request("role","post",data)
            onCancel()
            if(res){
            ...
            const res = request("role","put",data)
            onCloseModal()
            if(res){
                getList(); // re call function list 
            }else{
    ...
    return (
        <div>
            ...
            <div>Total: {total} Role</div>
                <Button onClick={onOpenModal}>New Role</Button>
            </div>
